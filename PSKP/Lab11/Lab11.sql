...
-- Step 2: Create a User mapped to the Login
CREATE USER student FOR LOGIN student;

GRANT CONNECT SQL TO student;
-- Step 3: Grant necessary privileges (e.g., SELECT, INSERT, UPDATE, DELETE) on a specific table
use KNI;
